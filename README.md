...
- 🔭 **I’m currently working on:** Building Retrieval-Augmented Generation (RAG) system applications using LangChain and OpenAI APIs for intelligent document querying and summarization.
- 🌱 **I’m currently learning:** Advanced prompt engineering, vector databases (like FAISS, Pinecone), and LLMOps for production-ready AI applications.
- 👯 **I’m looking to collaborate on:** AI/ML research projects, LangChain-based automation tools, and scalable backend systems using Python or Node.js.
- 🤔 **I’m looking for help with:** Improving performance and scalability in RAG systems, and integrating multi-modal capabilities.
- 💬 **Ask me about:** LLM integration, LangChain pipelines, real-time backend architectures, and cloud deployment.
